    ...
    def create_main_write_nodes(self, version):
        ...
        for main_write_node in main_write_nodes:
            ...
            if output_format_enum == '' or output_format_enum == 'exr':
                ...
                main_write_node["compression"].setValue(2)  # Zip (16 scanline)
                ...
                if version.task.project.name in ['Helgoland', 'Kein Tier', 'Wolf Hall', 'Castle', 'Drowak', 'Turbulence', 'Wing Woman', 'Broken Eggs', 'Westend Girl', 'Empress']:
