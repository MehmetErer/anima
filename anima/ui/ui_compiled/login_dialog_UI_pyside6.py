...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QtWidgets.QApplication.translate("Dialog", "Login to Stalker", None, -1))
        self.login_or_email_label.setText(QtWidgets.QApplication.translate("Dialog", "Login or email", None, -1))
